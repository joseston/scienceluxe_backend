...
class Proceso3CortoJob(db.Model):
	"""Proceso 3 Corto se ancla al mismo ID del Job de Proceso 1 Corto."""

	__tablename__ = 'proceso3_corto_jobs'
...
class Proceso3CortoSubprocessState(db.Model):
	__tablename__ = 'proceso3_corto_subprocess_states'
	...
	__table_args__ = (
		db.UniqueConstraint('proceso1_corto_job_id', 'subprocess_key', name='uq_proceso3_corto_job_subprocess_key'),
	)
