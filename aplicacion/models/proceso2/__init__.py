...
class Proceso2Job(db.Model):
	"""Proceso 2 se ancla a un Job existente de Proceso 1.

	Usamos el mismo ID (proceso1_job_id) como PK para que el usuario trabaje con
	un solo identificador de proyecto.
	"""

	__tablename__ = 'proceso2_jobs'
...
class Proceso2SubprocessState(db.Model):
	__tablename__ = 'proceso2_subprocess_states'
	...
	__table_args__ = (
		db.UniqueConstraint('proceso1_job_id', 'subprocess_key', name='uq_proceso2_job_subprocess_key'),
	)
